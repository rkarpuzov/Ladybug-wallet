...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String EXTERNAL_WALLET_BACKUP = "ladybug-wallet-backup" + FILENAME_NETWORK_SUFFIX;
	...
	private static final String EXPLORE_BASE_URL_PROD = "http://zetool.cointech.net/";
	private static final String EXPLORE_BASE_URL_TEST = "http://zetool.cointech.net/testnet/";
	...
	private static final String BITEASY_API_URL_PROD = "http://zetool.cointech.net/chain/Ladybug/";
	private static final String BITEASY_API_URL_TEST = "http://zetool.cointech.net/testnet/chain/Ladybug/";
	...
	public static final String VERSION_URL = "http://cointech.net/ladybug-wallet-version";

	/** MIME type used for transmitting single transactions. */
	public static final String MIMETYPE_TRANSACTION = "application/x-btctx";

	/** MIME type used for transmitting wallet backups. */
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-ladybug-wallet-backup";

	/** Number of confirmations until a transaction is fully confirmed. */
	public static final int MAX_NUM_CONFIRMATIONS = 7;

	/** User-agent to use for network access. */
	public static final String USER_AGENT = "Ladybug Wallet";
